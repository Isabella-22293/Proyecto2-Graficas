...
#[allow(dead_code)]
pub const RUSTC: &str = r"C:\\Users\\distelsa\\.rustup\\toolchains\\stable-x86_64-pc-windows-msvc\\bin\\rustc.exe";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub const RUSTDOC: &str = r"C:\\Users\\distelsa\\.rustup\\toolchains\\stable-x86_64-pc-windows-msvc\\bin\\rustdoc.exe";
...
#[doc=r#"The output of `C:\Users\distelsa\.rustup\toolchains\stable-x86_64-pc-windows-msvc\bin\rustc.exe -V`"#]
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.80.1 (3f5fd8dd4 2024-08-06)";
#[doc=r#"The output of `C:\Users\distelsa\.rustup\toolchains\stable-x86_64-pc-windows-msvc\bin\rustdoc.exe -V`; empty string if `C:\Users\distelsa\.rustup\toolchains\stable-x86_64-pc-windows-msvc\bin\rustdoc.exe -V` failed to execute"#]
#[allow(dead_code)]
